...
---
# Frame of Reference 
- A frame of reference is an arbitrary set of axes in a [[ Coordinate System|coordinate system]] from which the position and motion of of an object is described. 
- Each point in space is associated with as set of three real numbers, the [[Corrdinates|coordinates]] of the point, and this association is *unique*.  
